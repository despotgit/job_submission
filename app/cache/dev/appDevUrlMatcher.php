...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (rtrim($pathinfo, '/') === '') {
            if (substr($pathinfo, -1) !== '/') {
                return $this->redirect($pathinfo.'/', 'pirate_default_index');
            }
        ...
        // app_default_another
        if ($pathinfo === '/faruk') {
            return array (  '_controller' => 'AppBundle\\Controller\\DefaultController::anotherAction',  '_route' => 'app_default_another',);
        }
