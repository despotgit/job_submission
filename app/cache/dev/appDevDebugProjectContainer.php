...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'symfony2_test', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'/src/PirateBundle/Entity'))), 'PirateBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('AppBundle' => 'AppBundle\\Entity', 'PirateBundle' => 'PirateBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_4d1eb06681ecb7989bad26fc233493fb32cecb746c0f9ead0bd511bd777ef01d');
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('testerko');
        $a->setPassword('abcdefgh2');
        $a->setAuthMode(NULL);
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/PirateBundle/Resources/views'), 'Pirate');
        $instance->addPath(($this->targetDirs[3].'/src/AcmeTestBundle/Resources/views'), 'AcmeTest');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('6354b4910b350a8abe1f989cc2a020b7aab05d17');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('57c84e97d0b1e9.39237962')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'PirateBundle' => 'PirateBundle\\PirateBundle',
                'AcmeTestBundle' => 'AcmeTestBundle\\AcmeTestBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'symfony2_test',
            'database_user' => 'root',
            'database_password' => NULL,
            'mailer_transport' => 'smtp',
            'mailer_host' => '127.0.0.1',
            'mailer_user' => 'testerko',
            'mailer_password' => 'abcdefgh2',
            'secret' => '6354b4910b350a8abe1f989cc2a020b7aab05d17',
            'locale' => 'en',
            ...
            'kernel.secret' => '6354b4910b350a8abe1f989cc2a020b7aab05d17',
            ...
            'swiftmailer.mailer.default.transport.smtp.username' => 'testerko',
            'swiftmailer.mailer.default.transport.smtp.password' => 'abcdefgh2',
